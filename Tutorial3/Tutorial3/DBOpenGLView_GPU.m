...
- (void) initializeShaders
{
    ...
    shader1 = [self makeShaderOfType:GL_VERTEX_SHADER withShaderResource:@"VertexOffsetPosition"];
    shader2 = [self makeShaderOfType:GL_FRAGMENT_SHADER withShaderResource:@"VertexOffsetPosition"];
...
- (void)drawGLView
{
    GLfloat timeThruLoop = fmodf(renderTime, kLoopDuration);
