...
const GLfloat kFragLoopDuration = 5.0f;
...
- (void) initializeShaders
{
    ...
    shader1 = [self makeShaderOfType:GL_VERTEX_SHADER withShaderResource:@"VertexTimePosition"];
    shader2 = [self makeShaderOfType:GL_FRAGMENT_SHADER withShaderResource:@"VertexTimeColor"];
    ...
    GLuint loopLocation = glGetUniformLocation(shaderProgram, "loopDuration");
    GLuint fragLoopDuration = glGetUniformLocation(shaderProgram, "fragLoopDuration");
  
    glUniform1f(loopLocation, kLoopDuration);
    glUniform1f(fragLoopDuration, kFragLoopDuration);
...
- (void) prepareOpenGL
{
    ...
    glUniform2f(offsetLocation, 0.0, 0.0);
